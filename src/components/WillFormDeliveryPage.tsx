...
import './WillFormDeliveryPage.css';

const WillFormDeliveryPage: React.FC = () => {
  ...
  return (
    <div className="will-form-delivery-page">
      <Header />
          ...
          <form className="will-form" onSubmit={handleSubmit}>
            ...
            <section className="form-section">
              ...
              <p className="section-description">
                Where would you like your printed will delivered?
              </p>
...
export default WillFormDeliveryPage;
